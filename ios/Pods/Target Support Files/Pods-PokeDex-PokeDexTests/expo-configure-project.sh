...
with_node \
  ...
  --target "/Users/cgenao/Documents/ReactNativeProjects/ReactTutorial/PokeDex/ios/Pods/Target Support Files/Pods-PokeDex-PokeDexTests/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-constants" "expo-file-system" "expo-keep-awake" "react-native-image-colors"
